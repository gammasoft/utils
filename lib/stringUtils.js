...
/*
    ...
    linha.adicionarCampo.numerico
        .comNome('TIPO DE REGISTRO')
        .comDescricao('Blablabla')
        .comTamanho(1)
        .comCasasDecimais(5)
        .comValor(0);
*/
...
function Line(maxSize, parsers) {
    ...
    this.toString = function(separator, exportLabels) {
        ...
        return labels + records.join(separator);
    };
}
