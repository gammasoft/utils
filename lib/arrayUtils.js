...
module.exports.sort = function(array, order, property, deep) {
    ...
    return array.sort(function sorter(a, b) {
        a = getFromProperty ? objectUtils.resolveProperty(a, property, deep) : a;
        b = getFromProperty ? objectUtils.resolveProperty(b, property, deep) : b;
...
function findByComparator(array, strategy, property) {
    ...
    return array.reduce(function(a, b, index) {
        a = parseInt(getFromProperty ? a[property] : a, 10);
        b = parseInt(getFromProperty ? b[property] : b, 10);
